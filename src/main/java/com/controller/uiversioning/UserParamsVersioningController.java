...
public class UserParamsVersioningController {
    ...
    @GetMapping(path = {"/{userId}"}, params = "version=1")
    public UserDTOV1 getUserByIdV1(@Min(1) @PathVariable("userId") long userId, @RequestParam("version") int version) {
        try {
    ...
    @GetMapping(path = {"/{userId}"}, params = "version=2")
